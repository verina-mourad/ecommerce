...
const Navbar = () => {
  ...
  const musiccategory = categories.find(
  ...
  const SuperMarket = categories.find(
    (category) => category.name === `SuperMarket`,
  );
  useEffect(() => {
      ...
      <div className="bg-white shadow-2xl w-full sticky z-[999]  top-0 ">
        <div className="container mx-auto px-4  grid grid-cols-12 items-center py-3 gap-4">
          ...
          <div className=" col-span-7 md:col-span-2 ">
            <Link
              href="/"
              className="flex items-center gap-1 px-2 font-bold text-xl"
            >
