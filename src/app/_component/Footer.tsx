        ...
        <div className="grid grid-cols-2 gap-10 lg:grid-cols-4">
          <div className="col-span-1 md:col-span-1 mt-6 md:md-2">
            <div className="flex items-center gap-1 text-2xl">
              ...
              <p className="font-bold">
                Far <span className="text-blue-400">Mart</span>
              </p>
            </div>
            <p>
              Your one-stop shop for fresh, organic, and premium products
          ...
          <div className="flex flex-col mt-6 md:md-2 col-span-1 md:col-span-1">
            ...
            <p className="Links-contact">
              <FaLocationDot className="text-blue-400" /> 123 Market St, Cairo,
              Egypt
            </p>
            <p className="Links-contact">
              <BsFillTelephoneFill /> +20 123 456 789
            </p>
            <p className="Links-contact">
              <MdEmail /> support@farmart.com
            </p>
          </div>
        </div>
        <div className="flex items-center text-gray-400 justify-between mt-4">
          <p>© 2026 FarMart. All rights reserved.</p>
          <div className="text-gray-300 flex items-center gap-1">
            <FaCcVisa className="size-6" />
            <FaCcAmazonPay className="size-6" />
            <FaPaypal className="text-gray-300 size-6" />
