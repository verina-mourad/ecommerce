...
import { FaArrowAltCircleLeft, FaRegHeart } from "react-icons/fa";
import AddSpecialProduct from "./AddSpecialProduct";
import { Button } from "@src/components/ui/button";

const ProductDetailsClient = ({ product }: { product: ProductDetails }) => {
      ...
      <div className="container mx-auto">
        ...
        <div className="bg-white p-4 lg:flex items-center justify-center">
          ...
          <div>
            ...
            <p className="text-gray-500 text-3xl font-bold">{product?.slug}</p>
            ...
            <p className="text-xs text-gray-400">In Stock - Ready to ship</p>
            <div className="border border-1 bg-blue-400 " />
