...
const Cartfruits = () => {
  return (
    <>
      <div className="md:grid gap-4 md:grid-cols-4 mt-8">
        ...
        <div className="bg-blue-950 overflow-hidden m-4 p-7 md:col-span-2 relative  group flex flex-col gap-3 p-5 rounded-2xl mt-2 shadow-xl">
          <div className="z-10">
            <p className="text-white w-fit p-2 rounded-2xl shadow-xl bg-blue-400 text-sm">
              25% OFF
            </p>
            ...
            <p className="text-gray-400">
              Elevate your kitchen <br /> with premium greens.
            </p>
            <Link href="/Product" className="group/veg cursor-pointer">
              <Button className="bg-white rounded-2xl text-black p-3 group-hover/veg:text-white group-hover/veg:bg-blue-400 cursor-pointer">
                View Deals
              </Button>
            </Link>
          </div>
