...
export default async function Page({
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <p className="text-gray-400">shop from your favorite Music</p>
      ...
      <div className="flex flex-col md:flex-row items-center bg-gray-100 gap-2 shadow-2xl rounded">
        ...
        <p className="text-gray-400">
          found in <span className="text-blue-400">{categoryName}</span>
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 mt-4">
        {categoryDetails.map((sub: any) => (
          <div
            key={sub._id}
            className="bg-gray-100 rounded-2xl p-4 flex flex-col items-center gap-3 hover:shadow-lg transition"
          >
