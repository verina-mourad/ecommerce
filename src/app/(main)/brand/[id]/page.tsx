...
import BrandStructuredData from "../ProductStructuredData";
...
export async function generateMetadata({
  ...
  if (!brand) {
    return {
      ...
      alternates: {
        canonical: `https://ecommerce-dxjz.vercel.app/brand/${id}`,
      },
    };
  }
  return {
    title: `${brand.name} - Brand Page`,
    description: `Explore products from ${brand.name}.`,
    alternates: {
      canonical: `https://ecommerce-dxjz.vercel.app/brand/${id}`,
    },
  };
        ...
        <>
          ...
          <div>
            <div className="container mx-auto">
              <BreadCrumb brand={brand._id} brandname={brand.name} />
              ...
              <div className="container mx-auto px-4 mb-2 flex items-center gap-2">
                ...
                <Button className="py-2 flex items-center gap-2 transition-transform duration-300 hover:animate-pulse">
                  {brand?.name}
