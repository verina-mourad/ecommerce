...
import {
  ...
  Getwishlist,
  RemoveWishlist,
} from "@src/app/WishlistAction/WishlistAction";
      ...
      <div className="flex justify-between items-center m-4">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-gray-300">
              you have{" "}
              <span className="text-black">{whishlist.length} items saved</span>
            </p>
          </div>
        </div>
        <div onClick={ClearAllWishlist} className="group">
          <p className="text-red-400 hover:bg-red-100 rounded-2xl p-2 flex items-center gap-1 cursor-pointer">
            <FaRegTrashAlt className="group-hover:rotate-12 transition-all duration-300" />{" "}
            clear All Favorites
          </p>
        </div>
      </div>
            ...
            >
              <div className="relative w-full h-60 overflow-hidden group">
                ...
                <div className="absolute top-2 right-2 flex flex-col gap-2 opacity-0 group-hover:opacity-100 transition">
                  {/* love */}
                  <div
                    className="bg-white p-2 rounded-full shadow cursor-pointer hover:bg-red-100"
